<h1 class="gap">0x1E. C - Search Algorithms</h1><div class="gap" id="project-description">
<h2>Resources</h2>
<p><strong>Read or watch</strong>:</p>
<ul>
<li><a href="/rltoken/ntNFhA9urmBxZfcn8gjsqw" target="_blank" title="Search algorithm">Search algorithm</a> </li>
<li><a href="/rltoken/pPScxisIQ0eOPBPXkjcEmg" target="_blank" title="Space complexity (1)">Space complexity (1)</a> </li>
</ul>
<h2>Learning Objectives</h2>
<p>At the end of this project, you are expected to be able to <a href="/rltoken/dqyioMIfl-iR_MfK6WL8pQ" target="_blank" title="explain to anyone">explain to anyone</a>, <strong>without the help of Google</strong>:</p>
<h3>General</h3>
<ul>
